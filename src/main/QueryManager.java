...
public class QueryManager {
    ...
    public static void addØvelse(String navn, String beskrivelse, String apparat_id){
        String sql = String.format("INSERT INTO øvelse VALUES(%s,%s,%s,%s)", 0, navn, beskrivelse, apparat_id);
    ...
    public static void addTreningsøkt(String dato, String tidspunkt, String varighet, String form, String prestasjon, String notat_id){
        String sql = String.format("INSERT INTO treningsøkt VALUES(%s,%s,%s,%s,%s,%s,%s)", 0, dato, tidspunkt, varighet, form, prestasjon, notat_id);

    }
    public static void addNotat(String tekst){
        String sql = String.format("INSERT INTO notat VALUES(%s,%s)", 0, tekst);

    }
    public static void addApparat(String navn, String beskrivelse){
        String sql = String.format("INSERT INTO øvelse VALUES(%s,%s)", 0, beskrivelse);
